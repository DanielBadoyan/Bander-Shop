...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($count > 0) {
        ...
        $stmt = $pdo->prepare("INSERT INTO users (prenom, nom, email, mot_de_passe, age, adresse) VALUES (?, ?, ?, ?, ?, ?)");
        if ($stmt->execute([$prenom, $nom, $email, $mot_de_passe, $age, $adresse])) {
...
<head>
    ...
    <title>Inscription - BANDER-SHOP</title>
...
<header>
    <div class="header-container">
        ...
        <div class="header-actions">
            ...
            <a href="inscription.php"><i class="fas fa-user-plus"></i> <strong>S'inscrire</strong></a>
    ...
    <div class="auth-container">
        ...
        <form action="inscription.php" method="post">
            ...
            <div class="form-group">
                ...
                <span class="form-hint">Nous ne partagerons jamais votre email avec des tiers.</span>
            </div>

            <div class="form-group">
                <label for="mot_de_passe">Mot de passe</label>
                <input type="password" id="mot_de_passe" name="mot_de_passe" required>
                <span class="form-hint">Utilisez au moins 8 caractères avec des lettres et des chiffres.</span>
            </div>
        ...
        <div class="social-login">
            ...
            <div class="social-buttons">
                ...
                <a href="#" class="social-button apple"><i class="fab fa-apple"></i></a>
            </div>
        </div>
    </div>
</main>
