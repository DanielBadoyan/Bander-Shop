...
CREATE TABLE `order_products` (
  ...
  CONSTRAINT `order_products_chk_1` CHECK ((`quantite` > 0))
...
INSERT INTO `order_products` VALUES (1,1,1,15.99),(2,2,2,79.99),(2,3,1,59.99),(2,4,1,69.99),(2,5,1,39.99),(2,6,1,24.99),(3,9,1,43.00);
